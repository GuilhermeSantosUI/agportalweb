        ...
        <div className="w-full">
          <SheetHeader className="mb-4 gap-0">
            ...
            <p className="text-sm text-muted-foreground">
              Por razões de segurança, atualize seus dados no portal. Ao
              atualizar você pode ser redirecionado para a tela de login.
            </p>
          </SheetHeader>
          ...
          >
            <div className="pb-4">
              ...
              <div className="bg-yellow-50 border border-yellow-100 rounded px-3 py-2 text-sm text-amber-900 mb-4">
                Atenção: O tamanho máximo permitido para imagem de perfil é de
                100 KB.
              </div>
